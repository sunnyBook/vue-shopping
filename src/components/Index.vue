      ...
      <div class="product col-md-offset-2 col-sm-offset-2 col-md-8 col-sm-8">
        <div class="row">
          <div class="gallery col-md-6 col-sm-6">
            <img v-bind:src="iPhone6S.activeStyleUrl" class="img-responsive" alt="">
          </div>
          <div class="detail col-md-6 col-sm-6">
            <h3 class="name"><span>{{iPhone6S.name}}</span></h3>
            <hr>
            <div class="options">
              <dl class="dl-horizontal">
                <dt>描述：</dt>
                <dd><span>{{iPhone6S.desc}}</span></dd>
              </dl>
              <dl class="price dl-horizontal">
                <dt>价格：</dt>
                <dd class="pomegranage"><strong>￥<span>{{iPhone6S.price}}</span></strong></dd>
              </dl>
                ...
                <dd>
                  <ul>
                    <li v-for="(item, index) in iPhone6S.style"
                        ...
                        :class="{active: iPhone6S.activeStyleUrl == item}"
                    ><span>{{index}}</span></li>
                  </ul>
                </dd>
              </dl>
              <dl class="option dl-horizontal">
                ...
                <dd>
                  <ul>
                    <li v-for="(price, index) in iPhone6S.storage"
